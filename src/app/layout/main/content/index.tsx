...
const Content: FC = () => {
    return (
        <div className='section-content section-packages container section-pad-r'>
                        ...
                        <li className='package-item'>
                            <div className='package-item-wrapper'>
                                <div className='package-item-details'>
                                    ...
                                    <div className='pacakge-item-content'>
                                        ...
                                        <div className='package-item-description'>
                                            <p>
                                                Developed first by Joseph
                                                Pilates, after whom the
                                                technique is name...
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className='package-item-price'>
                                    ...
                                    <p className='price-amount'>$4,220/6 mo.</p>
                                </div>
